...
import 'package:mini_bank_app/features/transactions/presentation/remote_transactions_page.dart';
...
abstract class RouterModule {
  ...
  GoRouter router() => GoRouter(
        ...
        routes: <RouteBase>[
          ...
          GoRoute(path: AppRoutes.transactionsRemote, builder: (_, __) => const RemoteTransactionsPage()),
